...
/*	public static void main(String[] argg0) {
		...
		String path = "E:/tomcat/webapps/AutoCS/WEB-INF/UploadFiles/1443506252577.xls";
		String tname = "test1";
		EtoM etom = new EtoM(path, tname);
	}*/

	
	private String filePath = "E:/tomcat/webapps/AutoCS/WEB-INF/UploadFiles/";
	private String tablename = null;
	private static CourseSqlUtils courseSqlUtils = null;
	private static ChoseSqlUtils choseSqlUtils = null;
	
	
	public EtoM(String tablename) {
		this.filePath = this.filePath+tablename;
